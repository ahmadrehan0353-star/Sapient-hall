...
export const siteConfig = {
  ...
  description:
    "Top quality education at an affordable cost — a purpose-built, two-campus school in Rawalpindi and Islamabad taking students from Pre-School to Matric, O and A Levels.",
...
export const navItems: NavItem[] = [
  { label: "About", href: "/about" },
  {
    ...
    children: [
      ...
      { label: "Secondary", href: "/academics/secondary", description: "Grades 9–10, Matric & O Levels" },
      { label: "Cambridge Advanced", href: "/academics/cambridge-advanced", description: "AS & A Levels" },
    ],
  },
  { label: "Admissions", href: "/admissions" },
  { label: "Facilities", href: "/facilities" },
  { label: "School Life", href: "/student-life" },
  {
    label: "News & Events",
    href: "/news",
    children: [
