...
import {
  ...
  Stethoscope, ShieldCheck, TreePine, Theater, Projector,
} from "lucide-react";
...
export const facilitiesList: Facility[] = [
  {
    id: "science-labs", image: siteImages.facilities.teaching, name: "Science Laboratories", icon: FlaskConical,
  ...
  {
    id: "computer-labs", image: siteImages.facilities.computerLabs, name: "Computer Laboratories", icon: Monitor,
  ...
  {
    id: "library", image: siteImages.facilities.library, name: "Library", icon: BookMarked,
  ...
  {
    id: "sports-complex", image: siteImages.facilities.campus, name: "Sports Complex", icon: Trophy,
  ...
  {
    id: "swimming-pool", image: siteImages.facilities.pool, name: "Swimming Pool & Gym", icon: Waves,
  ...
  {
    id: "security", image: siteImages.facilities.cctv, name: "Security & CCTV", icon: ShieldCheck,
  ...
  {
    id: "playground", image: siteImages.facilities.playgrounds, name: "Playgrounds", icon: TreePine,
  ...
  {
    id: "multimedia-room", name: "Multi-Media Room", icon: Projector, image: siteImages.facilities.teaching,
    description: "A dedicated multi-media room brings lessons to life with audio-visual teaching — because some concepts are better shown than told.",
    highlights: ["Audio-visual lessons", "Used across all grades", "Supports activity-based learning"],
    imageCount: 2,
  },
  {
