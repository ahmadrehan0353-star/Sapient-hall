      ...
      <section className="container-page section-y grid grid-cols-1 gap-12 lg:grid-cols-2">
        <Reveal>
          ...
          <p className="mt-4 text-body-md text-navy-600">
            Sapient Hall endeavours to introduce a whole new dimension to the schooling system.
            Our emphasis has always remained on creating and maintaining an atmosphere which is
            homely and conducive to learning. The school promotes learning not only through a
            carefully planned curriculum, but also by enabling each child to experience and
            explore various corridors of knowledge at their own pace.
          </p>
          <p className="mt-4 text-body-md text-navy-600">
            Parents gradually note the interest their child develops in the school — and the
            ensuing change in their very outlook. Your child will look forward to coming to
            school each day and take pride in their achievements. That is our target for every
            child that comes into our care: our purpose-built premises, the learning environment
            created within them, and the able, dedicated guidance of experienced teaching staff
            together accomplish a wondrous transformation of personality in our students.
          </p>
        </Reveal>
        <Reveal delay={0.1}>
          <ImagePlaceholder src={siteImages.campuses.flagship} alt="Flagship Campus, Adyala Road" label="Flagship Campus, Adyala Road" aspect="aspect-[4/3]" />
        </Reveal>
      </section>
