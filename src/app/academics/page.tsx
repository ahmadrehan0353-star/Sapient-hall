...
export const metadata: Metadata = {
  title: "Academics",
  description:
    "Pre-School to A Levels at Sapient Hall — affiliated with the Federal Board for Matriculation, CAIES, and Cambridge University.",
};
  ...
  return (
    <>
      <PageHero
        ...
        description="Affiliated with the Federal Board for Matriculation, and with CAIES and Cambridge University — every stage builds on the last, with no jarring transitions between schools."
